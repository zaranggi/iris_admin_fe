...
<v-container fluid>
  ...
  >
    ...
    <v-card-title>Tambah Data Departemen</v-card-title>
       ...
       <v-flex lg12 md12 sm12>
          <v-row dense>
            <v-col cols="12" lg="4">   
              ...
              ></v-text-field>  
               <v-btn small color="teal accent-3" class="d-flex justify-end mb-2" @click="saveDep">
                Simpan
              </v-btn>
            </v-col>  
          </v-row>
