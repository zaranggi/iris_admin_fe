  ...
  methods: {
    saveMenu() {
      if(this.$refs.form.validate()){  
        ...
        link: this.link,
        id_main: this.listMainMenu ==="" || this.listMainMenu === null ? 0 : this.listMainMenu,
        urut: this.urut,
        ...
        active: this.active === true ? 'Y' : 'N',
          ...
          this.$store
          .dispatch("simpanUpdateMenu", datanya)
          .then(() => 
