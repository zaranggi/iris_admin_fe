...
export default {
  ...
  methods: {
    ...
    getData() {
        this.$store.dispatch("getOneSetemail", {id: this.$route.params.id})
          .then(response => { 
            const n = response[0] 
            this.email1 = n.email1 
            this.email2 = n.email2 
            this.email3 = n.email3 
            this.email4 = n.email4 
            this.email5 = n.email5 
            this.listCabangEmail = n.kdcab
